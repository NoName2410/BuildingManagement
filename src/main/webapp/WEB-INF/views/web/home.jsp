                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-3">
                        <div class="search-item">
                            ...
                            <select class="search-option" name="search-option" id="search-option-district">
                    ...
                    <div class="col-12 col-md-3">
                        <div class="search-item">
                            ...
                            <select class="search-option" name="search-option" id="search-option-property">
                    ...
                    <div class="card-body p-2 px-5 text-center">
                        <div class="md-5 md-4 mt-4 pb-2">
                            ...
                            <div class="form-outline form-white mb-2">
                                ...
                                <input type="text" id="typeEmailXR" class="form-control form-control-lg"/>
                            </div>
                            ...
                            <p class="text-center text-muted mt-2 mb-0">Have already an account?
                                <a href="#" class="fw-bold text-body"><u style="color: white ;">Login here</u></a></p>
                            </form>
