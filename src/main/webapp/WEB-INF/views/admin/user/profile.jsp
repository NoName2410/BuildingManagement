...
<div class="main-content">
    ...
    <script>
        // Lấy formUrl từ JSP
        var formUrl = '${formUrl}'; // Đảm bảo rằng formUrl được định nghĩa trong JSP
        ...
        function updateInfo(data, username) {
            $.ajax({
                url: formUrl + '/profile/' + username, // Xác định đúng đường dẫn
                type: 'PUT',
                dataType: 'json',
                contentType: 'application/json',
                data: JSON.stringify(data),
                success: function (res) {
                    window.location.href = formUrl + '/admin/profile/' + res.userName + '?message=update_success';
                },
                error: function (res) {
                    console.log(res);
                    window.location.href = formUrl + '/admin/profile/' + username + '?message=error_system';
                }
            });
        }
    </script>
